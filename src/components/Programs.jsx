...
const ProgramCard = ({
  ...
  <div className='w-full md:w-[48%]'>
    ...
    >
      <div className={`bg-white rounded-xl md:rounded-[22px] px-6 md:px-8 lg:px-10 flex flex-col justify-between h-full ${
        index <= 5 
          ? 'py-4 md:py-5 min-h-[220px] md:min-h-[240px]' 
          : 'py-5 md:py-6 min-h-[260px] md:min-h-[280px]'
      }`}>
          ...
          <div className='flex-1 flex flex-col gap-1.5'>
            <h3 className={`text-black font-bold ${
              index <= 5 
                ...
                : 'text-xl md:text-[22px] lg:text-[24px]'
            }`}>{localizedTitle}</h3>
            ...
            } text-[#5B21B6] bg-[#F2E8C6] px-4 md:px-5 lg:px-6 py-1.5 md:py-2 rounded-xl md:rounded-2xl inline-block font-medium shadow-sm text-center whitespace-nowrap mx-auto md:mx-0 mt-0.5`}><i>{date}</i></p>
          </div>
        ...
        <div className={`flex-1 flex ${index <= 5 ? 'mt-2.5 md:mt-3' : 'mt-3 md:mt-4'}`}>
          <p 
            className={`text-text-dark tracking-normal ${
              ...
              index <= 5
                ? 'text-xs md:text-sm lg:text-[14px]'
                : 'text-sm md:text-[14.5px] lg:text-[15px] leading-relaxed'
...
const Programs = () => {
  ...
  return (
    <div className='mt-12 bg-cream-200 rounded-[40px] shadow-lg border border-cream-300 p-[6px]'>
      ...
      <div className={`-mt-12 md:-mt-16 lg:-mt-20 pb-10 md:pb-12 lg:pb-14 ${styles.paddingX} flex flex-wrap gap-4 md:gap-6 lg:gap-7 justify-center md:justify-between items-stretch`}>
